...
X_train = joblib.load('data/x_train_r.joblib')
y_train = joblib.load('data/y_train_r.joblib')
x_val = joblib.load('data/x_val_r.joblib')
y_val = joblib.load('data/y_val_r.joblib')
...
print('dec tree cv1 acc =:  ',accuracy_score(y_val,cv1))
print('dec tree CV1 f1 score= ' , f1_score(y_val,cv1,average='micro'))
joblib.dump(dgs1, "1-dectree1-r.joblib")
...
print('dec  tree SMOTE cv1 acc =:  ',accuracy_score(y_val,cv2))
print('dec tree CV2 f1 score= ' , f1_score(y_val,cv2,average='micro'))
print('parameters=',dgs2.best_params_)
joblib.dump(dgs2, "2-dectree2-r.joblib")
...
print('RF cv acc 1 =:  ',accuracy_score(y_val,cv1))
print('RF CV1 f1 score= ' , f1_score(y_val,cv1,average='micro'))
print('parameters=',RFgs1.best_params_)
joblib.dump(rfmodel1, "3-rf1-r.joblib")
acc.append(accuracy_score(y_val,cv1))
f1.append(f1_score(y_val,cv1,average='micro'))
...
print('RF SMOTE cv acc2 =:  ',accuracy_score(y_val,cv2))
print('RF CV2 f1 score= ' , f1_score(y_val,cv2,average='micro'))
print('parameters=',RFgs2.best_params_)
joblib.dump(rfmodel2, "4-rf2-r.joblib")
acc.append(accuracy_score(y_val,cv2))
f1.append(f1_score(y_val,cv2,average='micro'))
...
print('adaboost cv acc 1 =:  ',accuracy_score(y_val,cv1))
print('adaboost CV1 f1 score= ' , f1_score(y_val,cv1,average='micro'))
print('parameters=',adgs1.best_params_)
joblib.dump(adgs1, "5-ada1-r.joblib")
acc.append(accuracy_score(y_val,cv1))
f1.append(f1_score(y_val,cv1,average='micro'))
...
print('adaboost SMOTE cv acc2 =:  ',accuracy_score(y_val,cv2))
print('adaboost CV2 f1 score= ' , f1_score(y_val,cv2,average='micro'))
print('parameters=',adgs2.best_params_)
joblib.dump(adgs2, "6-ada2-r.joblib")
acc.append(accuracy_score(y_val,cv2))
f1.append(f1_score(y_val,cv2,average='micro'))
...
print('gb cv acc 1 =:  ',accuracy_score(y_val,cv1))
print('gb CV1 f1 score= ' , f1_score(y_val,cv1,average='micro'))
print('parameters=',gbgs1.best_params_)
joblib.dump(gbgs1, "7-gb1-r.joblib")
...
print('gb SMOTE cv acc2 =:  ',accuracy_score(y_val,cv2))
print('gb CV2 f1 score= ' , f1_score(y_val,cv2,average='micro'))
print('parameters=',gbgs2.best_params_)
joblib.dump(gbgs2, "8-gb2-r.joblib")
...
joblib.dump(knngs1, "9-knn1-r.joblib")
...
joblib.dump(knngs2, "10-knn2-r.joblib")
...
joblib.dump(sgs1, "11-svm1-r.joblib")

acc.append(accuracy_score(y_val,cv1))
f1.append(f1_score(y_val,cv1,average='micro'))

print('model by accuracy = ',(np.argmax(np.array(acc)))+1)  ##index starts from 0
